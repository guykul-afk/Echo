...
- **מרכיבי המסך:**
  1. **כרטיסי 4 הממדים (The 4 Human Dimensions):**
     ...
     - **עובדות קשיחות:** (נתונים שקרו בפועל).
     - **הנחות שלך:** (השערות ופרשנות).
     - **המידע החסר להחלטה:** (פערי מידע ושאלות פתוחות).
...
```
+------------------------------------------+
| ✧ שלב 2: שקיפות המראה (The Epistemic Mirror) |
|------------------------------------------|
| 🎯 מה חשוב לי?                         |
| [ לשמור זמן בבית ולקבל שכר גבוה באטלס ]  |
|------------------------------------------|
| 🧱 עובדות קשיחות                        |
| [ הוצע לי חוזה עם השכר המבוקש       ]    |
|------------------------------------------|
| 💭 ההנחות שלי                           |
| [ משרה כזו תדרוש שעות ארוכות כל יום ]    |
|------------------------------------------|
| 🔍 המידע החסר להחלטה                    |
| [ מה רמת הזמינות שנדרשת בפועל בערב  ]    |
|                                          |
