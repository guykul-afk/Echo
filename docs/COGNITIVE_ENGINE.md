...
| **ההנחות שלי** | פרשנות, הערכות עתידיות, וציפיות שהמשתמש גוזר מהעובדות. |
| **המידע החסר להחלטה** | פערי מידע, שאלות פתוחות וגורמים שמונעים כרגע קבלת החלטה ברורה. |

*הערה: הניסוח תמיד ישתמש בשפה עדינה ואמפתית כמו "הבנתי שחשוב לך..." או "ההנחה המרכזית שלך היא..." במקום קביעות פסקניות.*
